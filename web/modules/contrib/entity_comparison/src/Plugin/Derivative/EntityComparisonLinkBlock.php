 ...
 *
 * @see \Drupal\entity_comparison\Plugin\Block\EntityComparisonLinkBlock
 */
class EntityComparisonLinkBlock extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    foreach ($this->entityComparison->loadMultiple() as $id => $entity) {
      ...
      $this->derivatives[$id]['admin_label'] = t('Entity comparison link: @label', ['@label' => $entity->label()]);
